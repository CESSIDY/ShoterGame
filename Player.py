...
class Player(object):
    walkRight = [pygame.image.load('resources/images/R1.png').convert(),
                 pygame.image.load('resources/images/R2.png').convert(),
                 pygame.image.load('resources/images/R3.png').convert(),
                 pygame.image.load('resources/images/R4.png').convert(),
                 pygame.image.load('resources/images/R5.png').convert(),
                 pygame.image.load('resources/images/R6.png').convert(),
                 pygame.image.load('resources/images/R7.png').convert(),
                 pygame.image.load('resources/images/R8.png').convert(),
                 pygame.image.load('resources/images/R9.png').convert()]
    walkLeft = [pygame.image.load('resources/images/L1.png').convert(),
                pygame.image.load('resources/images/L2.png').convert(),
                pygame.image.load('resources/images/L3.png').convert(),
                pygame.image.load('resources/images/L4.png').convert(),
                pygame.image.load('resources/images/L5.png').convert(),
                pygame.image.load('resources/images/L6.png').convert(),
                pygame.image.load('resources/images/L7.png').convert(),
                pygame.image.load('resources/images/L8.png').convert(),
                pygame.image.load('resources/images/L9.png').convert()]
    bullet_img_left = pygame.transform.scale(pygame.image.load('resources/images/bullets/bullet4_left.png').convert(),
                                             (10, 10))
    bullet_img_right = pygame.transform.scale(pygame.image.load('resources/images/bullets/bullet4_right.png').convert(),
                                              (10, 10))
    shield_width = 50
    shield_height = 50
    shield = pygame.transform.scale(pygame.image.load('resources/images/baff/shield.png').convert(),
